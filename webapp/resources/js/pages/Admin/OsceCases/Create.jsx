...
export default function Create({ defaults }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        duration_minutes: defaults?.duration_minutes ?? 15,
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.osce-cases.store'));
    };
            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                <div className="space-y-6">
                    <div className="text-center space-y-2 mb-6">
                        <h1 className="text-2xl font-semibold text-foreground">Create OSCE Case</h1>
                        <p className="text-muted-foreground">Capture the essentials for a new training scenario.</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="clean-card bg-card p-6 space-y-5">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Provide a clear description for trainees.</p>
                            </div>
                        ...
                        <div className="clean-card bg-card p-6 space-y-5">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Outline timing and learning objectives.</p>
                            </div>
