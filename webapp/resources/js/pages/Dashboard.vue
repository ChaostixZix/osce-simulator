...
const statCards = [
    {
        title: 'OSCE Cases',
        value: props.stats.osce_cases_active,
        icon: Stethoscope,
        emoji: '🩺',
        route: '/osce',
    ...
    },
    {
        ...
        value: props.stats.mcq_available,
        icon: Brain,
        emoji: '🧠',
        route: '/mcq',
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4 overflow-x-auto">
            ...
            <div class="text-center space-y-4">
                <h1 class="text-3xl font-bold">{{ welcome.title }}</h1>
                <p class="text-lg text-muted-foreground">{{ welcome.message }}</p>
